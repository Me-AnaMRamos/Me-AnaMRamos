...
I'm a Mathematician & Computer Scientist working on formal models for decision-making in economics and the role of artificial intelligence within them, with experience in statistical modeling and evaluation.
...
- Emphasis on metric choice, thresholds, and error analysis  
...
### 🛠 Tools & foundations
- **Modeling & statistics:** Probability, statistical learning, optimization
- **Machine learning:** PyTorch, scikit-learn, classical & neural models
- **Programming:** Python, Julia, SQL, C/C++
- **Practice:** Reproducible experiments, documented assumptions, clear metrics

---

### 📫 Contact
- Email: anramosp@unal.edu.co  
- GitHub: https://github.com/Me-AnaMRamos
